...
| `area-middleware` | `#fbca04` | Tareas de middleware y comunicación front-back |
...
| Manuel | Setup de Middleware + health-check + endpoints CRUD profesores | `sprint-2`, `area-middleware` | Ninguna |
...
| Manuel | Enrutamiento CRUD frontend → backend | `sprint-3`, `area-middleware` | Endpoints middleware (Sprint 2) |
...
| Manuel | Tests unitarios modelo de datos | `sprint-4`, `area-middleware` | Modelo datos (Sprint 3) |
...
| Manuel | Validador de datos + tests de restricciones automatizados | `sprint-5`, `area-middleware` | Tests unitarios (Sprint 4) |
...
| Manuel | Pruebas integración front→middle→back + reporte | `sprint-6`, `area-middleware` | Enrutamiento CRUD (Sprint 3) |
...
| Manuel | Tests con datos reales + casos de conflicto | `sprint-7`, `area-middleware` | Integración (Sprint 6) |
...
| Manuel | Tests de carga + validación tiempos de respuesta | `sprint-8`, `area-middleware` | Tests data real (Sprint 7) |
...
| Manuel | Tests integración completos + reporte estabilidad | `sprint-9`, `area-middleware` | Tests carga (Sprint 8) |
...
| Manuel | Tests exhaustivos con data real + issue tracking | `sprint-10`, `area-middleware` | Tests integración (Sprint 9) |
...
| Manuel | Sesión teórica + demo del sistema + demo formal | `sprint-13`, `area-middleware` | Sprint 12 |
